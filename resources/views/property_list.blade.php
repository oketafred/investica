				...
				<div class="listing-item">
					...
					<a href="{{ route('property-detail-info', $property->id) }}" class="listing-img-container">
						...
						<div class="listing-img-content">
							<span class="listing-price">${{ number_format($property->price) }}</span>
						</div>
					...
					<div class="listing-content">
						...
						<div class="listing-title">
							...
							<a href="{{ route('property-detail-info', $property->id) }}" class="listing-address popup-gmaps">
								<i class="fa fa-map-marker"></i>
								{{ substr($property->address, 0, 30) }}, {{ $property->city }}
							</a>
						...
						<ul class="listing-details">
							<li>{{ $property->bed_rooms }} Bed Rooms</li>
							<li>{{ $property->bath_rooms }} Bath Rooms</li>
							<li>{{ $property->area == 0 ? 'Unknown' : $property->area }} sq ft </li>
						</ul>
